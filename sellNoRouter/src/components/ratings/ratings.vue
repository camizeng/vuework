<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect @typeSelect="typeSelect" @conToggle="contentToggle" :select-type="selectType" :only-content="onlyContent" :ratings="ratings"></ratingselect>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      needShow(type, text) {
        if (this.onlyContent && !text) { // 当设置了只显示有内容的，则无内容的 不显示
          return false;
        }
      ...
      .rating-item
        ...
        .content
          ...
          .recommend
            ...
            .item
              padding: 0 6px
              border: 1px solid rgba(7,17,27,.02)
              border-radius: 1px
              color: rgb(147,153,159)
              background: #fff
          .time
